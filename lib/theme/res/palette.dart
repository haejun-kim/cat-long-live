...
abstract class Palette {
  /// Chromatic color (유채색)
  static Color blue = const Color(0xFF2A6ACF);
  static Color pressedBlue = const Color(0x1A4281FF);
  static Color red = const Color(0xFFDE3B40);
  static Color green = const Color(0xFF30D567);
